...
const userSchema = new Schema(
  {
    ...
    courses: {
      type: String,
      enum: ['Web-Dev', 'UX/UI', 'Data', 'Cyber_Security', 'undefined'] // undefined to solve user model validation generated by enum
    },
    promo: String,
    // campus: String,
    campus: {
      type: String,
      enum: ['Amsterdam', 'Barcelona', 'Berlin', 'Lisboa', 'Madrid', 'Mexico', 'Miami', 'Paris', 'Remote', 'Sao_Paulo', 'undefined']
    },
